            ...
            <div className='bg-[#0A0806] px-[24px] sm:px-[35px] md:px-[50px] lg:px-[70px] xl:px-[90px] 2xl:px-[120px] pt-[24px] sm:pt-[30px] md:pt-[40px] lg:pt-[60px] xl:pt-[80px] 2xl:pt-[96px]'>
                <div className='grid grid-cols-12 gap-[30px] pb-[35px] sm:pb-[44px] md:pb-[54px] lg:pb-[64px] xl:pb-[74px] 2xl:pb-[84px]'>
                    <div className='col-span-6 sm:col-span-4 feature'>
                        ...
                        <svg className='w-[25spx] sm:w-[40px] lg:w-[64px] cursor-pointer' viewBox="0 0 63 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg className='w-[25spx] sm:w-[40px] lg:w-[64px] cursor-pointer' viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='col-span-2 flex sm:justify-center'>
                        <ul classsName='flex flex-col feature'>
                            <li className='compais  mb-[16px] md:mb-[22px] duraction-300 xl:mb-[28px] feature'>Funding Programs</li>
                            <li className='meedicalkitslist cursor-pointer hover:text-[#ABE004] duraction-300 mb-[8px] md:mb-[12px] xl:mb-[16px] feature'>2-Step</li>
                            <li className='meedicalkitslist cursor-pointer hover:text-[#ABE004] duraction-300 mb-[8px] md:mb-[12px] xl:mb-[16px] feature'>1-Step</li>
                            <li className='meedicalkitslist cursor-pointer hover:text-[#ABE004] duraction-300 mb-[8px] md:mb-[12px] xl:mb-[16px] feature'>No-evaluation</li>
                            <li className='meedicalkitslist cursor-pointer hover:text-[#ABE004] duraction-300 feature mb-[8px] md:mb-[12px] xl:mb-[16px]'>Success stories</li>
                            <li className='meedicalkitslist cursor-pointer feature hover:text-[#ABE004] duraction-300'>Become an affiliate</li>
                        </ul>
                    </div>
                    
                    <div className='col-span-2 flex sm:justify-center'>
                        <ul classsName='flex flex-col feature'>
                            <li className='compais mb-[16px] md:mb-[22px] xl:mb-[28px]  duraction-300'>Resources</li>
                            <li className='meedicalkitslist cursor-pointer hover:text-[#ABE004] duraction-300 mb-[8px] md:mb-[12px] xl:mb-[16px] feature'>Academy</li>
                            <li className='meedicalkitslist cursor-pointer hover:text-[#ABE004] duraction-300 mb-[8px] md:mb-[12px] xl:mb-[16px] feature'>FAQs</li>
                            <li className='meedicalkitslist cursor-pointer hover:text-[#ABE004] duraction-300 mb-[8px] md:mb-[12px] xl:mb-[16px] feature'>Blog</li>
                            <li className='meedicalkitslist cursor-pointer hover:text-[#ABE004] duraction-300 mb-[8px] md:mb-[12px] xl:mb-[16px]'>Calculators</li>
                            <li className='meedicalkitslist cursor-pointer hover:text-[#ABE004] duraction-300 '>Sky trade manager</li>
                        </ul>
                    </div>
                    <div className='col-span-2 flex sm:justify-center'>
                        <ul classsName='flex flex-col feature'>
                            <li className='compais  mb-[16px] md:mb-[22px] xl:mb-[28px] feature duraction-300'>More</li>
                            <li className='meedicalkitslist cursor-pointer hover:text-[#ABE004] duraction-300 mb-[8px] md:mb-[12px] xl:mb-[16px] feature'>About us</li>
                            <li className='meedicalkitslist cursor-pointer hover:text-[#ABE004] duraction-300 mb-[8px] md:mb-[12px] xl:mb-[16px] feature'>Partners</li>
                            <li className='meedicalkitslist cursor-pointer hover:text-[#ABE004] duraction-300 mb-[8px] md:mb-[12px] xl:mb-[16px] feature'>Media kit</li>
                            <li className='meedicalkitslist cursor-pointer hover:text-[#ABE004] duraction-300 mb-[8px] md:mb-[12px] xl:mb-[16px] feature'>Merchandise</li>
                            <li className='meedicalkitslist cursor-pointer hover:text-[#ABE004] duraction-300 '>Symbols specifications</li>
                        </ul>
                    </div>
                    <div className='col-span-2 flex sm:justify-centercenter'>
                        <ul classsName='flex flex-col feature'>
                            <li className='compais  mb-[16px] md:mb-[22px] xl:mb-[28px] feature s duraction-300'>Contact</li>
